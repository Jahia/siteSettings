                ...
                <div class="container-fluid">
                    ...
                    <div class="row-fluid">
                        <div class="span4">
                            ...
                            <input type="password" name="password" class="span12" id="password" value="" autocomplete="new-password">
                        </div>
                        <div class="span4">
                            <label for="passwordConfirm"><fmt:message key="label.confirmPassword"/> <span class="text-error"><strong>*</strong></span></label>
                            <input type="password" name="passwordConfirm" class="span12" id="passwordConfirm" value="" autocomplete="new-password">
                        </div>
                    </div>
