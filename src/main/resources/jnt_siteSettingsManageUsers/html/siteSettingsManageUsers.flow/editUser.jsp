                ...
                <div class="container-fluid">
                    <div class="row-fluid">
                        <div class="span4">
                            ...
                            <input class="span12" type="password" name="password" id="password" value=""${userProperties.readOnly or userProperties.external ? ' disabled="disabled"' : ''} autocomplete="new-password">
                        ...
                        <div class="span4">
                            ...
                            <input class="span12" type="password" name="passwordConfirm" id="passwordConfirm" value=""${userProperties.readOnly or userProperties.external ? ' disabled="disabled"' : ''} autocomplete="new-password">
                            <div style="margin-bottom:15px;" class="text-info">&nbsp;(<fmt:message key="siteSettings.user.edit.password.no.change"/>)</div>
                        </div>
                    </div>
                </div>
