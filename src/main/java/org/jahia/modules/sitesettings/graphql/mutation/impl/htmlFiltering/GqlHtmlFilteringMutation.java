...
public class GqlHtmlFilteringMutation {
    ...
    public Boolean getUpdateTags(@GraphQLNonNull @GraphQLName("siteKey") String siteKey, @GraphQLName("tags") @GraphQLDescription("Updated list of tags, supply null to remove al tags.") List<String> tags) {
